...
describe("Model (Facade)", () => {
  ...
  describe("public API delegates", () => {
    it("delegates helper calls to appropriate domain classes", () => {
      ...
      assert.strictEqual(Model.pickCalendarColor("", 0), "#ea4335")
      ...
      assert.strictEqual(Model.hm(ev.start, true), "10AM")
      assert.strictEqual(Model.timeRange(ev.start, ev.end, false, true), "10AM–10:30 AM")
